...
@prop1 = Prop.create!(name: "Inception Totem", price: 100, category: "accessories", description: " Pow Movie time!", user: @jester_john)
...
@prop2 = Prop.create!(name: "Harry Potter Wand", price: 1000, category: "weapons", description: "Avada kedavra!", user: @propper_gary)
...
@prop3 = Prop.create!(name: "Guts' Giant Sword", price: 900, category: "weapons", description: "Humans are weak!", user: @weeb215)
...
@prop4 = Prop.create!(name: "The One Ring", price: 10000, category: "accessories", description: "My precious!", user: @propper_gary)
...
@prop5 = Prop.create!(name: "Batmobile", price: 10, category: "vehicles", description: "I am batman!", user: @propper_gary)
...
@prop6 = Prop.create!(name: "Coop's Damn Good Cup of Coffee", price: 11, category: "other", description: "Lets drink!", user: @jjwahl)
...
@prop7 = Prop.create!(name: "Pulp Fiction Briefcase", price: 19, category: "accessories", description: "Say what again i dare you i double dare you!", user: @kinophile)
...
@prop8 = Prop.create!(name: "Fight Club Soap", price: 1, category: "other", description: "First rule of fight club is that we dont speak about fight club!", user: @jester_john)
...
@prop9 = Prop.create!(name: "Paterson's Notebook", price: 10, category: "other", description: "Go read!", user: @jjwahl)
