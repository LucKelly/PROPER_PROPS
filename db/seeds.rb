...
@prop1 = Prop.create!(name: "Inception Totem", price: 100, category: "accessories", description: " This is the real inception totem!", user: @jester_john)
...
@prop3 = Prop.create!(name: "Guts' Giant Sword", price: 900, category: "weapons", description: "The real Demon slayer used in the live action of guts big and heavy!", user: @weeb215)
...
@prop4 = Prop.create!(name: "The One Ring", price: 10000, category: "accessories", description: "The real one ring from lord of the rings size various finger to finger!", user: @propper_gary)
...
@prop7 = Prop.create!(name: "Pulp Fiction Briefcase", price: 19, category: "accessories", description: "Steven hibbert Briefcase used in pulp fiction!", user: @kinophile)
...
@prop8 = Prop.create!(name: "Fight Club Soap", price: 1, category: "other", description: "Smell like a fighter with the soup from fight club!", user: @jester_john)
...
@prop9 = Prop.create!(name: "Paterson's Notebook", price: 10, category: "other", description: "Write your notes in petterson notebook!", user: @jjwahl)
...
@prop10 = Prop.create!(name: "Tarkowsky's Weird Floor", price: 2, category: "other", description: "Feel like a cloud with tarkwosky floor!", user: @kinophile)
